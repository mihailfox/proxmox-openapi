...
import { NORMALIZED_IR_CACHE_PATH, RAW_SNAPSHOT_CACHE_PATH } from "../shared/paths.ts";
...
function parseArgs(argv: string[]): CliOptions {
  let inputPath = RAW_SNAPSHOT_CACHE_PATH;
  let outputPath = NORMALIZED_IR_CACHE_PATH;
